...
const INDICATOR_TEXT: Record<number, string> = {
...
function NetworkIndicator() {
  ...
  const audioLossRateLower =
    room.remoteUsers.find((user) => user.userId === botName)?.audioStats?.audioLossRate || 0;
